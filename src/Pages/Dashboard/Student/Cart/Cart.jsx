                ...
                <tbody>
                    {
                        ...
                        items.map((data, _idx) => <tr key={_idx} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td className="px-2 py-4">
                                {
                                    data?.availableSeats > 0 ?
                                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Proceed To Pay</button>
                                        :
                            ...
                            <td className="px-2 py-4 " onClick={() => { deleteCartItem(data?._id); refetch(); }}>
                                ...
                                <svg className="cursor-pointer flex-shrink-0 w-5 h-5 text-red-500 transition duration-75 dark:text-red-400 group-hover:text-red-900" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
